#!/bin/bash
#SBATCH --job-name=9_10_snap_coarse_128m_2mpp_cont
#SBATCH --output=sbatch_outputs/9_10_snap_coarse_128m_2mpp_cont.out
...
# # 9_{1,4,8} SNAP coarse - 2x - 64m # 4090
# EXPERIMENT_NAME="9_8_snap_coarse_64m_1mpp"
# python -m maploc.train experiment.name=$EXPERIMENT_NAME \
#         data.crop_size_meters=128 \
#         data.max_init_error=96 \
#         data.pixel_per_meter=1 \
...
# # 9_{2,3,9} SNAP coarse - 4x - 2mpp # 4090
# EXPERIMENT_NAME="9_9_snap_coarse_128m_2mpp"
# python -m maploc.train experiment.name=$EXPERIMENT_NAME \
#         data.crop_size_meters=256 \
#         data.max_init_error=192 \
#         data.pixel_per_meter=0.5 \
