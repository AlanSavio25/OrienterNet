...
class GenericModule(pl.LightningModule):
    ...
    def validation_step(self, batch, batch_idx):
        ...
        if batch_idx == 0 or batch_idx ==  20:
            ...
            plots = plot_example_single(0, None, pred, batch, results, plot_bev=True, out_dir=None, show_gps=True, return_plots=True)
            for i, plot in enumerate(plots):
                self.logger.experiment.add_image(f"Visualizations/{batch_idx}/{i}", plot, self.global_step)
