    ...
    def metrics(self):
        ...
        return {
            **metrics,
            ...
            "xy_recall_1m": Location2DRecall(1.0, key="tile_T_cam_max"),
            "xy_recall_3m": Location2DRecall(3.0, key="tile_T_cam_max"),
            "xy_recall_5m": Location2DRecall(5.0, key="tile_T_cam_max"),
            "yaw_recall_1°": AngleRecall(1.0, "tile_T_cam_max"),
            "yaw_recall_3°": AngleRecall(2.0, "tile_T_cam_max"),
