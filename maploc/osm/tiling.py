...
class TileManager:
    ...
    def from_bbox(
        ...
        cached_tileloader = twm.DiskCached(tileloader, "/cluster/project/infk/cvg/students/alpaul/OrienterNet/datasets/cache/")
    ...
    def query(self, bbox: BoundaryBox) -> Canvas:
        ...
        # aerial = np.zeros((3, canvas.h, canvas.w), np.uint8)
